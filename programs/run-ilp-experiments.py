...
parser.add_argument('solver', type=str, help='path to your ILP-sover')
...
def work(in_file):
    ...
    if split_line in opt_sizes:
    	...
    	opt_size = "-1"
    #opt_size = "-1"
    sp.call(["bash","test-instance-ilps",in_file, "java -jar "+args.solver, str(args.time_limit), args.solver+".res", opt_size, split_line+".log", split_line+".time"])
    return 0
