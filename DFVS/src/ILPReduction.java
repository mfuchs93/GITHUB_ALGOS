...
//            int l = 0;
//            for (HashSet<Vertex> c: clique.getCliques()) {
//                GRBLinExpr cexpr = new GRBLinExpr();
//                for (Vertex v :
//                        c) {
//                    cexpr.addTerm(1.0, model.getVarByName("x" + v.getName()));
//                }
//                model.addConstr(cexpr,GRB.GREATER_EQUAL, c.size() -1, "cl" + l++);
//            }
            model.update();
            model.optimize();
